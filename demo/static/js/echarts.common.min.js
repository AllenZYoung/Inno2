!function (t, e) {
    ...
    return function (t) {
        ...
        }, O = Object.prototype.toString, z = Array.prototype, E = z.forEach, N = z.filter, R = z.slice, B = z.map, V = z.reduce, F = {
            inherits: u,
            mixin: c,
            clone: i,
            merge: n,
         ...
         */
        var w = i(10), M = i(125), S = i(93), T = i(23), A = i(126), I = i(13), C = i(16), k = i(59), L = i(28), P = i(3), D = i(6), O = i(47), z = i(78), E = i(1), N = i(19), R = i(21), B = i(46), V = E.each, F = I.parseClassType, G = 1e3, H = 5e3, W = 1e3, Z = 2e3, q = 3e3, j = 4e3, U = 5e3, X = "__flagInMainProcess", Y = "__hasGradientOrPatternBg", $ = "__optionUpdated", Q = /^[a-zA-Z0-9_]+$/;
        ...
        var et = [], it = {}, nt = [], rt = [], ot = [], at = {}, st = {}, lt = {}, ht = {}, ut = new Date - 0, ct = new Date - 0, dt = "_echarts_instance_", ft = {
            version: "3.4.0",
        ...
        M.Group = i(34), M.Image = i(49), M.Text = i(76), M.Circle = i(160), M.Sector = i(166), M.Ring = i(165), M.Polygon = i(162), M.Polyline = i(163), M.Rect = i(164), M.Line = i(161), M.BezierCurve = i(159), M.Arc = i(158), M.CompoundPath = i(153), M.LinearGradient = i(91), M.RadialGradient = i(154), M.BoundingRect = i(9), M.extendShape = function (t) {
            ...
            var n = e.getShallow("position") || "inside", r = e.getShallow("offset"), o = n.indexOf("inside") >= 0 ? "white" : i, a = e.getModel("textStyle");
            m.extend(t, {
        ...
        var r = i(1), o = i(9), a = i(4), s = i(8), l = a.parsePercent, h = r.each, u = {}, c = u.LOCATION_PARAMS = ["left", "right", "top", "bottom", "width", "height"];
        ...
        (function (e) {
            ...
            var o = "undefined", a = "undefined" == typeof window ? e : window, s = typeof a.Float64Array === o ? Array : a.Float64Array, l = typeof a.Int32Array === o ? Array : a.Int32Array, h = {
                ...
                number: Array,
                time: Array
            }, u = i(11), c = i(43), d = i(1), f = i(6), p = d.isObject, g = ["stackedOn", "hasItemOption", "_nameList", "_idList", "_rawData"], m = function (t, e) {
        ...
        "use strict";
        var n = i(1), r = i(8), o = i(15), a = i(6), s = i(13), l = i(57), h = i(10), u = i(12), c = o.set, d = o.get, f = r.encodeHTML, p = r.addCommas, g = s.extend({
            ...
            formatTooltip: function (t, e, i) {
                ...
                var a = d(this, "data"), s = this.getRawValue(t), l = f(n.isArray(s) ? o(s) : p(s)), h = a.getName(t), u = a.getItemVisual(t, "color");
                n.isObject(u) && u.colorStops && (u = (u.colorStops[0] || {}).color), u = u || "transparent";
                var c = '<span style="display:inline-block;margin-right:5px;border-radius:10px;width:9px;height:9px;background-color:' + f(u) + '"></span>', g = this.name;
        ...
        function s(t, e, i, r, o, a) {
            ...
            if (n(c) && n(d))if (n(l))a[0] = 0; else {
                ...
                if (n(m)) {
                    ...
                    var A = (2 * c * l - 3 * s * d) / (2 * b(c * c * c)), I = Math.acos(A) / 3, C = b(c), k = Math.cos(I), g = (-l - 2 * C * k) / (3 * s), y = (-l + C * (k + S * Math.sin(I))) / (3 * s), L = (-l + C * (k - S * Math.sin(I))) / (3 * s);
        ...
        h.getScaleExtent = function (t, e) {
            var i, n, r, o = t.scale, l = o.type, h = e.getMin(), u = e.getMax(), c = null != h, d = null != u, f = o.getExtent();
            ...
            var i = t.scale, n = h.getScaleExtent(t, e), r = null != e.getMin(), o = null != e.getMax(), a = e.get("splitNumber");
        ...
        "use strict";
        var n = i(18), r = i(5), o = i(75), a = i(9), s = i(33).devicePixelRatio, l = {
            M: 1,
            L: 2,
            C: 3,
            Q: 4,
                ...
                for (var e, i, n, r, o, a, s = this.data, h = this._ux, u = this._uy, c = this._len, d = 0; d < c;) {
                    ...
                    switch (1 == d && (n = s[d], r = s[d + 1], e = n, i = r), f) {
                        ...
                        case l.Q:
                            ...
                            break;
                        case l.A:
                            var p = s[d++], v = s[d++], x = s[d++], _ = s[d++], b = s[d++], w = s[d++], M = s[d++], S = s[d++], T = x > _ ? x : _, A = x > _ ? 1 : x / _, I = x > _ ? _ / x : 1, C = Math.abs(x - _) > .001, k = b + w;
        ...
        var n = i(4), r = i(8), o = i(32), a = Math.floor, s = Math.ceil, l = n.getPrecisionSafe, h = n.round, u = o.extend({
            type: "interval",
            _interval: 0,
        ...
        var o = i(1), a = i(10), s = i(2), l = i(6), h = i(68), u = i(182), c = o.each, d = h.eachAxisDim, f = s.extendComponentModel({
            type: "dataZoom",
        ...
        c._updateCommon = function (t, e, i, n) {
            ...
            var c = n && n.itemStyle, m = n && n.hoverItemStyle, v = n && n.symbolRotate, y = n && n.symbolOffset, x = n && n.labelModel, _ = n && n.hoverLabelModel, b = n && n.hoverAnimation;
        ...
        var s = i(1), l = i(8), h = i(3), u = i(11), c = i(4), d = c.remRadian, f = c.isRadianAroundZero, p = i(5), g = p.applyTransform, m = s.retrieve, v = Math.PI, y = function (t, e) {
        ...
        var x = {
            axisLine: function () {
                ...
                if (l && !o.isBlank()) {
                    var c = i.getModel("axisLabel"), d = c.getModel("textStyle"), f = c.get("margin"), p = o.scale.getTicks(), g = i.getFormattedLabels(), y = m(e.labelRotation, c.get("rotate")) || 0;
                    y = y * v / 180;
                    ...
                    if (s.each(p, function (t, r) {
                            if (!_(o, r, e.labelInterval)) {
                                ...
                                var s = a.getTextColor() || i.get("axisLine.lineStyle.color"), l = o.dataToCoord(t), c = [l, e.labelOffset + e.labelDirection * f], p = o.scale.getLabel(t), m = new h.Text({
                                    anid: "label_" + t,
                                    style: {
                                        text: g[r],
                ...
                if (i) {
                    ...
                    }) : i, I = e.get("tooltip", !0), C = e.mainType, k = {componentType: C, name: i, $vars: ["name"]};
        ...
        var h = i(12), u = i(22), c = i(1), d = i(121), f = i(119), p = c.each, g = u.ifAxisCrossZero, m = u.niceScaleExtent;
        i(122);
        var v = o.prototype;
        ...
        var n = i(8), r = i(1), o = {}, a = ["x", "y", "z", "radius", "angle", "single"], s = ["cartesian2d", "polar", "singleAxis"];
        ...
        var r = i(6), o = i(1), a = i(10), s = i(8), l = s.addCommas, h = s.encodeHTML, u = i(2).extendComponentModel({
            ...
            formatTooltip: function (t) {
                var e = this.getData(), i = this.getRawValue(t), n = o.isArray(i) ? o.map(i, l).join(", ") : l(i), r = e.getName(t), a = h(this.name);
                ...
                if (!e.isSeriesFiltered(t)) {
                    ...
                    o.each(function (t) {
                        ...
                        if (s)n.setItemVisual(e, "color", s); else {
                            var l = n.getItemModel(e), h = l.get("itemStyle.normal.color") || t.getColorFromPalette(n.getName(e), i);
        ...
        var n = i(5), r = i(18), o = {}, a = Math.min, s = Math.max, l = Math.sin, h = Math.cos, u = n.create(), c = n.create(), d = n.create(), f = 2 * Math.PI;
        ...
        s.prototype = {
            constructor: s, drawRectText: function (t, e, i) {
                ...
                if (null != s && (s += ""), s) {
                    t.save();
                    var l, h, u = o.textPosition, c = o.textOffset, d = o.textDistance, f = o.textAlign, p = o.textFont || o.font, g = o.textBaseline, m = o.textVerticalAlign;
         ...
         */
        var r = i(64), o = i(10), a = i(1), s = i(140), l = i(143), h = i(144), u = i(152), c = !o.canvasSupported, d = {canvas: i(142)}, f = {}, p = {};
        ...
        function a(t, e, i, n, r, o, a) {
            var s = e.getItemVisual(i, "color"), c = e.getItemVisual(i, "opacity"), d = n.getModel("itemStyle.normal"), f = n.getModel("itemStyle.emphasis").getBarItemStyle();
        ...
        var d = i(2).extendChartView({
            type: "bar", render: function (t, e, i) {
                ...
                var s = this.group, l = t.getData(), u = this._data, c = t.coordinateSystem, d = c.getBaseAxis(), f = d.isHorizontal(), p = t.isAnimationEnabled() ? t : null;
        ...
        var h = i(24), u = i(5), c = i(177), d = i(3), f = i(1), p = i(4), g = ["fromSymbol", "toSymbol"], m = l.prototype;
        ...
        function h(t, e, i) {
            var n = t.getAngleAxis(), r = t.getRadiusAxis(), o = r.getExtent(), a = n.getExtent(), s = Math.PI / 180, l = new v.Sector({
                shape: {
                    cx: t.cx,
                    cy: t.cy,
                    r0: o[0],
        ...
        t.exports = _.extend({
            type: "line", init: function () {
                ...
                var o = this._polyline, a = this._polygon, s = t.hostModel, l = m(this._data, t, this._stackedOnPoints, e, this._coordSys, i), h = l.current, u = l.stackedOnCurrent, d = l.next, f = l.stackedOnNext;
        ...
        var u = i(28).extend({
            type: "pie", init: function () {
                ...
                if (!r || r.from !== this.uid) {
                    var a = t.getData(), s = this._data, h = this.group, u = e.get("animation"), c = !s, d = t.get("animationType"), f = l.curry(n, this.uid, t, u, i), p = t.get("selectedMode");
                    if (a.diff(s).add(function (t) {
                        ...
                        var g = a.getItemLayout(0), m = Math.max(i.getWidth(), i.getHeight()) / 2, v = l.bind(h.removeClipPath, h);
        ...
        t.exports = function (t, e, i, n) {
            ...
            l.each(function (i) {
                ...
                var L = g.getModel("textStyle").getFont(), P = g.get("rotate") ? b < 0 ? -_ + Math.PI : -_ : 0, D = t.getFormattedLabel(i, "normal") || l.getName(i), O = o.getBoundingRect(D, L, d, "top");
                u = !!P, f.label = {
                    x: n,
                    y: r,
                    position: m,
        ...
        t.exports = function (t, e, i, h) {
            e.eachSeriesByType(t, function (t) {
                ...
                var u = i.getWidth(), c = i.getHeight(), d = Math.min(u, c), f = r(e[0], u), p = r(e[1], c), g = r(h[0], d / 2), m = r(h[1], d / 2), v = t.getData(), y = -t.get("startAngle") * l, x = t.get("minAngle") * l, _ = v.getSum("value"), b = Math.PI / (_ || v.count()) * 2, w = t.get("clockwise"), M = t.get("roseType"), S = t.get("stillShowZeroSum"), T = v.getDataExtent("value");
                T[0] = 0;
        ...
        var r = i(1), o = i(3), a = i(51), s = a.ifIgnoreOnTick, l = a.getInterval, h = ["axisLine", "axisLabel", "axisTick", "axisName"], u = ["splitArea", "splitLine"], c = i(2).extendComponentView({
            type: "axis",
            render: function (t, e) {
                this.group.removeAll();
            ...
            _splitArea: function (t, e, i) {
                var n = t.axis;
                if (!n.isBlank()) {
                    var a = t.getModel("splitArea"), h = a.getModel("areaStyle"), u = h.get("color"), c = e.coordinateSystem.getRect(), d = n.getTicksCoords(), f = n.scale.getTicks(), p = n.toGlobalCoord(d[0]), g = n.toGlobalCoord(d[0]), m = 0, v = l(a, i), y = h.getAreaStyle();
                    u = r.isArray(u) ? u : [u];
        ...
        function x(t, e, i, n) {
            var r = n.brushStyle.lineWidth || 0, o = U(r, Q), a = i[0][0], s = i[1][0], l = a - r / 2, h = s - r / 2, u = i[0][1], c = i[1][1], d = u - o + r / 2, f = c - o + r / 2, p = u - a, g = c - s, m = p + r, v = g + r;
        ...
        var R = i(21), B = i(1), V = i(9), F = i(3), G = i(117), H = i(43), W = B.curry, Z = B.each, q = B.map, j = Math.min, U = Math.max, X = Math.pow, Y = 1e4, $ = 6, Q = 6, K = "globalPan", J = {
            w: [0, 0],
            e: [0, 1],
            n: [1, 0],
            s: [1, 1]
        ...
        var u = i(1), c = i(6), d = i(11), f = u.each, p = u.filter, g = u.map, m = u.isArray, v = u.indexOf, y = u.isObject, x = i(13), _ = i(127), b = "\0_ec_inner", w = d.extend({
        ...
        var a = i(1), s = i(134), l = [["x", "left"], ["y", "top"], ["x2", "right"], ["y2", "bottom"]], h = ["grid", "geo", "parallel", "legend", "toolbox", "title", "visualMap", "dataZoom", "timeline"], u = ["bar", "boxplot", "candlestick", "chord", "effectScatter", "funnel", "gauge", "lines", "graph", "heatmap", "line", "map", "parallel", "pie", "radar", "sankey", "scatter", "treemap"], c = a.each;
        t.exports = function (t) {
        ...
        var n = i(1), r = i(4), o = i(8), a = i(38), s = a.prototype, l = Math.ceil, h = Math.floor, u = 1e3, c = 60 * u, d = 60 * c, f = 24 * d, p = function (t, e, i, n) {
            for (; i < n;) {
                var r = i + n >>> 1;
                t[r][2] < e ? i = r + 1 : n = r
            }
        ...
        var c = i(33), d = i(1), f = i(48), p = i(9), g = i(46), m = i(141), v = i(62), y = 5, x = new p(0, 0, 0, 0), _ = new p(0, 0, 0, 0), b = function (t, e, i) {
            ...
            for (var u = 0, p = 0, g = 0, y = 0, x = 0, _ = 0; _ < t.length;) {
                ...
                switch (b === h.M && _ > 1 && (i || (u += m(p, g, y, x, r, l))), 1 == _ && (p = t[_], g = t[_ + 1], y = p, x = g), b) {
                    ...
                    case h.Q:
                        ...
                        break;
                    case h.A:
                        var w = t[_++], M = t[_++], S = t[_++], T = t[_++], A = t[_++], I = t[_++], C = (t[_++], 1 - t[_++]), k = Math.cos(A) * S + w, L = Math.sin(A) * T + M;
        ...
        var h = i(29).CMD, u = i(88), c = i(148), d = i(89), f = i(147), p = i(63).normalizeRadian, g = i(18), m = i(90), v = u.containStroke, y = 2 * Math.PI, x = 1e-4, _ = [-1, -1, -1], b = [-1, -1];
        t.exports = {
        ...
        var h = i(25), u = i(1), c = i(21), d = i(10), f = i(150), p = h.addEventListener, g = h.removeEventListener, m = h.normalizeEvent, v = 300, y = ["click", "dblclick", "mousewheel", "mouseout", "mouseup", "mousedown", "mousemove", "contextmenu"], x = ["touchstart", "touchend", "touchmove"], _ = {
            pointerdown: 1,
            pointerup: 1,
            pointermove: 1,
            pointerout: 1
        ...
        var r = i(18), o = i(5), a = r.quadraticSubdivide, s = r.cubicSubdivide, l = r.quadraticAt, h = r.cubicAt, u = r.quadraticDerivativeAt, c = r.cubicDerivativeAt, d = [];
        t.exports = i(7).extend({
            type: "bezier-curve",
        ...
        var n = i(10), r = i(7), o = [["shadowBlur", 0], ["shadowColor", "#000"], ["shadowOffsetX", 0], ["shadowOffsetY", 0]];
        t.exports = r.extend({
            type: "sector",
        ...
        function n(t, e, i, n, r, o, a, s, l, h, u) {
            ...
            _ > 1 && (a *= c(_), s *= c(_));
            var b = (r === o ? -1 : 1) * c((a * a * (s * s) - a * a * (x * x) - s * s * (y * y)) / (a * a * (x * x) + s * s * (y * y))) || 0, w = b * a * x / s, M = b * -s * y / a, S = (t + i) / 2 + f(g) * w - d(g) * M, T = (e + n) / 2 + d(g) * w + f(g) * M, A = v([1, 0], [(y - w) / a, (x - M) / s]), I = [(y - w) / a, (x - M) / s], C = [(-1 * y - w) / a, (-1 * x - M) / s], k = v(I, C);
        ...
        var a = i(7), s = i(29), l = i(170), h = i(20), u = ["m", "M", "l", "L", "v", "V", "h", "H", "z", "Z", "c", "C", "q", "Q", "t", "T", "s", "S", "a", "A"], c = Math.sqrt, d = Math.sin, f = Math.cos, p = Math.PI, g = function (t) {
        ...
        c.prototype = {
            constructor: c, hostedBy: function (t) {
                ...
                var e = this._dataExtent, i = this.getAxisModel(), n = i.axis.scale, o = [0, 100], a = [t.start, t.end], l = [];
        ...
        var r = i(41), o = i(1), a = i(85), s = i(189), l = o.bind, h = r.extend({
            ...
            _onZoom: function (t, e, i, r, o, a) {
                ...
                if (h) {
                    var c = u[e](null, [o, a], h, i, t), d = (c.pixel - c.pixelStart) / c.pixelLength * (l[1] - l[0]) + l[0];
        ...
        var r = i(1), o = i(3), a = i(47), s = i(41), l = o.Rect, h = i(4), u = h.linearMap, c = i(12), d = i(85), f = h.asc, p = r.bind, g = r.each, m = 7, v = 1, y = 30, x = "horizontal", _ = "vertical", b = 5, w = ["line", "bar", "candlestick", "scatter"], M = s.extend({
            type: "dataZoom.slider",
            init: function (t, e) {
            ...
            _updateDataInfo: function (t) {
                function e(t) {
                    var e = o.getTransform(n.handles[t].parent, this.group), i = o.transformDirection(0 === t ? "right" : "left", e), l = this._handleWidth / 2 + b, h = o.applyTransform([d[t] + (0 === t ? -l : l), this._size[1] / 2], e);
                    r[t].setStyle({
                        x: h[0],
                        y: h[1],
        ...
        o.onclick = function (t, e) {
            ...
            if (o.href = s, "function" != typeof MouseEvent || r.browser.ie || r.browser.edge) {
                var l = i.get("lang"), h = '<body style="margin:0;"><img src="' + s + '" style="max-width:100%;" title="' + (l && l[0] || "") + '" /></body>', u = window.open();
                u.document.write(h)
            } else {
        ...
        var s = i(1), l = i(19), h = i(25), u = i(8), c = s.each, d = u.toCamelCase, f = i(10), p = ["", "-webkit-", "-moz-", "-o-"], g = "position:absolute;display:block;border-style:solid;white-space:nowrap;z-index:9999999;";
        a.prototype = {
        ...
        i(2).extendComponentView({
            type: "tooltip", _axisPointers: {}, init: function (t, e) {
                ...
                if (n.from !== this.uid) {
                    var e = this._ecModel, o = n.seriesIndex, a = e.getSeriesByIndex(o), i = this._api, s = "axis" === this._tooltipModel.get("trigger");
                ...
                if (i)if (this._lastX = t.offsetX, this._lastY = t.offsetY, e && null != e.dataIndex) {
                    var a = e.dataModel || r.getSeriesByIndex(e.seriesIndex), s = e.dataIndex, l = a.getData(), h = l.getItemModel(s);
                ...
                function s(i, n, o) {
                    var a = "x" === i ? r(n[0], o[0], n[0], o[1]) : r(o[0], n[1], o[1], n[1]), s = h._getPointerElement(e, t, i, a);
                ...
                function l(i, n, r) {
                    var a = e.getAxis(i), s = a.getBandWidth(), l = r[1] - r[0], u = "x" === i ? o(n[0] - s / 2, r[0], s, l) : o(r[0], n[1] - s / 2, l, s), c = h._getPointerElement(e, t, i, u);
                    d ? f.updateProps(c, {shape: u}, t) : c.attr({shape: u})
                }

                var h = this, u = t.get("type"), c = e.getBaseAxis(), d = a && "cross" !== u && "category" === c.type && c.getBandWidth() > 20;
                ...
                function a(i, n, o) {
                    var a = e.getAxis(), l = a.orient, u = "horizontal" === l ? r(n[0], o[0], n[0], o[1]) : r(o[0], n[1], o[1], n[1]), c = s._getPointerElement(e, t, i, u);
                    h ? f.updateProps(c, {shape: u}, t) : c.attr({shape: u})
                }

                var s = this, l = t.get("type"), h = o && "cross" !== l && "category" === e.getBaseAxis().type, u = e.getRect(), c = [u.y, u.y + u.height];
                a(i, n, c)
                ...
                var h = this, u = t.get("type"), c = e.getAngleAxis(), d = e.getRadiusAxis(), p = o && "cross" !== u && "category" === e.getBaseAxis().type;
                ...
                var h = e.get("type"), u = e.getModel(h + "Style"), c = "shadow" === h, d = u[c ? "getAreaStyle" : "getLineStyle"](), p = "polar" === t.type ? c ? "Sector" : "radius" === i ? "Circle" : "Line" : c ? "Rect" : "Line";
                ...
                if (e.length) {
                    ...
                    if (f.dispatchAction({
                        ...
                        if (r)u(o || a.get("position"), i[0], i[1], a.get("confine"), this._tooltipContent, v, null, f); else {
                            var y = c[h].dataIndexInside, x = "time" === s.type ? s.scale.getLabel(n[l]) : e[h].getData().getName(y), _ = (x ? g.encodeHTML(x) + "<br />" : "") + p.map(e, function (t, e) {
                ...
                var h = this._tooltipModel, u = t.getModel("tooltip", h), c = new _(s, u, u.ecModel), d = t.getDataParams(e, i), f = t.formatTooltip(e, !1, i), p = "item_" + t.name + "_" + e;
        ...
        if (!i(10).canvasSupported) {
            var n = i(5), r = i(9), o = i(29).CMD, a = i(19), s = i(17), l = i(77), h = i(36), u = i(49), c = i(76), d = i(7), f = i(37), p = i(171), g = Math.round, m = Math.sqrt, v = Math.abs, y = Math.cos, x = Math.sin, _ = Math.max, b = n.applyTransform, w = ",", M = "progid:DXImageTransform.Microsoft", S = 21600, T = S / 2, A = 1e5, I = 1e3, C = function (t) {
                ...
                for (a = 0; a < t.length;) {
                    switch (r = t[a++], n = "", i = 0, r) {
                        ...
                        case d:
                            ...
                            a++;
                            var G = t[a++], H = z + y(B) * N, W = E + x(B) * R, M = z + y(V) * N, A = E + x(V) * R, Z = G ? " wa " : " at ";
